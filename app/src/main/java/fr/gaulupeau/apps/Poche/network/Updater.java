...
public class Updater {
    ...
    private long performUpdate(ArticlesChangedEvent event, boolean full,
        ...
        Set<com.di72nn.stuff.wallabag.apiwrapper.models.Annotation> processedApiAnnotations = new HashSet<>();
        Set<com.di72nn.stuff.wallabag.apiwrapper.models.Annotation.Range> presentApiAnnotationRanges = new HashSet<>();
            ...
            for(com.di72nn.stuff.wallabag.apiwrapper.models.Article apiArticle: articles.embedded.items) {
                ...
                if (existing) {
                    ...
                    for (Annotation annotation : annotations) {
                        com.di72nn.stuff.wallabag.apiwrapper.models.Annotation apiAnnotation
                        ...
                        if (apiAnnotation == null) {
                            ...
                            for (AnnotationRange range : annotation.getRanges()) {
                                com.di72nn.stuff.wallabag.apiwrapper.models.Annotation.Range apiRange
                            ...
                            for (com.di72nn.stuff.wallabag.apiwrapper.models.Annotation.Range apiRange : apiAnnotation.ranges) {
                ...
                for (com.di72nn.stuff.wallabag.apiwrapper.models.Annotation apiAnnotation : apiArticle.annotations) {
    ...
    private com.di72nn.stuff.wallabag.apiwrapper.models.Annotation findApiAnnotation(
            Integer annotationId, List<com.di72nn.stuff.wallabag.apiwrapper.models.Annotation> annotations) {
        if (annotationId == null) return null;

        for (com.di72nn.stuff.wallabag.apiwrapper.models.Annotation annotation : annotations) {
    ...
    private com.di72nn.stuff.wallabag.apiwrapper.models.Annotation.Range findApiAnnotationRange(
            AnnotationRange range, List<com.di72nn.stuff.wallabag.apiwrapper.models.Annotation.Range> ranges) {
        for (com.di72nn.stuff.wallabag.apiwrapper.models.Annotation.Range apiRange : ranges) {
    ...
    private void performSweep(ArticlesChangedEvent event, ProgressListener progressListener,
        ...
        if(!articlesToDelete.isEmpty()) {
            Log.d(TAG, String.format("performSweep() %d articles to delete", articlesToDelete.size()));
            ...
            Log.d(TAG, "performSweep() deleting articles");
